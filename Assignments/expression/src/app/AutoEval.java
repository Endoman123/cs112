...
public class AutoEval {
    public static void main(String[] args) {
        try {
            testExpression("3"); // 3
            testExpression("a", "etest1.txt"); // 3
            testExpression("10E-2"); // 0.1
            ...
            testExpression("13 / 73 * 38 + 41 / 33 / 89 * 56 + 67 / 81 / 77 - (78) + 95 + 40 - 86 / 2 * (81) + (29 - 48) - 48 + 88 / 16 * 20 / 43 + 20 * 86 / 87 * 11 + 79 - 28"); // -3214.4111
            testExpression("(64 * 74) - (64 - (72 / (31 / (34 / 83 / 23) + 63 / 96) - 77)) - (90 + 88 + (52 + 36)) + (23 * 47) / 25 + (36) + (15 * ((5 * 6) * (32))) - (38 + 21) - (60 + 18) + 26 * (92 / 88 / 25 * 53 + 70 - 68 + 40 / 43 - (73) + (39 / 9) * (90 + 75) + 59 - 92 + 85) - 92 + 56 + 16 / 14 / ((93 - 56) / (((43 + 76 - 91 + 13)) / 11)) / (23 - ((36 / 54) + 30 * 33 - 91 + (48 / 77) * (61 / 8)) - (25 / 68) - 30 + 38 / 81 + 85 * 59) * 2 / (33 * (74 - 26)) + 46 - 10 - 97 + (61 / 61 - 33 - ((86) / 62)) + 53"); // 36771.707
